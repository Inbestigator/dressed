  ...
  ((module.exports = function ($$$config) {
    ...
    function preloadInstanceAndSuspendIfNeeded(workInProgress, type, props) {
      if (maySuspendCommit(type, props)) {
        if (
          ((workInProgress.flags |= 16777216), !preloadInstance(type, props))
        ) {
    ...
    var MAYBE_ITERATOR_SYMBOL = Symbol.iterator,
      ...
      // TODO Remove this and the prod overrides once RR doesn't use React.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE
      // This is required because Nextjs and other frameworks strip client fields from React on the server
    ...
    exports.flushSyncFromReconciler = function (fn) {
      ...
      try {
        if (
          (setCurrentUpdatePriority(2), (ReactSharedInternals.T = null), fn)
        ) {
          return fn();
        }
      } finally {
