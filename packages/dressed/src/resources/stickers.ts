 ...
 */
export async function getSticker(sticker: Snowflake): Promise<RESTGetAPIGuildStickerResult> {
 ...
 */
export async function listStickerPacks(): Promise<RESTGetStickerPacksResult["sticker_packs"]> {
 ...
 */
export async function getStickerPack(pack: Snowflake): Promise<RESTGetAPIStickerPackResult> {
 ...
 */
export async function listStickers(guild: Snowflake): Promise<RESTGetAPIGuildStickersResult> {
 ...
 * @param sticker The sticker to get
 */
export async function getGuildSticker(guild: Snowflake, sticker: Snowflake): Promise<RESTGetAPIGuildStickerResult> {
 ...
 */
export async function deleteSticker(guild: Snowflake, sticker: Snowflake): Promise<void> {
